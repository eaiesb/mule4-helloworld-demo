...
<tr><td style="background-color:#33339F;color:white"><b>git url</b></td><td>${ENV, var=""${env.GU}"}</td></tr>
<tr><td style="background-color:#33339F;color:white"><b>git commiter name</b></td><td>${ENV, var="JAVA_HOME"}</td></tr>
</table>
